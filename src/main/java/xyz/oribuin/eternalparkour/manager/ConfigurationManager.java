...
public class ConfigurationManager extends AbstractConfigurationManager {
    ...
    public enum Setting implements RoseSetting {
        ...
        RUNNER_TIME("runner-timer", null, "This is the task that will show the current time on the runner's HUD."),
        ...
        RUNNER_TIME_MESSAGE("runner-timer.message", "<gradient:#00B4DB:#0083B0>Time <gray>- <white>%time%",
                "The message to display in the actionbar for the runner timer.",
                "Use %time% for the current time.",
                "If you are not using PaperMC, Swap <gray> and <white> for &7 and &f respectively."),

        // Editor Task Settings
        EDITOR_TASK("editor-task", null, "This is the task that will show the player visual indicators when editing a level."),
        EDITOR_TASK_ENABLED("editor-task.enabled", true, "Should the editor task be enabled?"),
